// Country dial codes for the phone field. iso2 maps to a flag-icons SVG.
// Generated + adversarially verified (ISO 3166-1 alpha-2 + ITU E.164).
// 245 entries. NANP +1 territories share "+1"; sorted priority-first.
...
export const COUNTRIES: Country[] = [
  ...
  { name: "Aland Islands", iso2: "ax", dial: "+358" },
  ...
  { name: "Bonaire, Sint Eustatius and Saba", iso2: "bq", dial: "+599" },
  ...
  { name: "Saint Barthelemy", iso2: "bl", dial: "+590" },
  ...
  { name: "U.S. Virgin Islands", iso2: "vi", dial: "+1" },
